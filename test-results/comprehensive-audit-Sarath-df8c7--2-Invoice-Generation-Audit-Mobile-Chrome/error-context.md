...
Call log:
  - waiting for locator('button:has-text("BILL")')
    - locator resolved to 6 elements. Proceeding with the first one: <button class="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl transition-all text-left group text-slate-600 hover:bg-slate-50 hover:text-slate-900">…</button>
