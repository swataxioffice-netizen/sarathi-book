...
const AdminPanel: React.FC = () => {
    ...
    const DocumentsView = () => (
        <div className="flex flex-col items-center justify-center py-20 bg-white rounded-2xl border border-slate-200 border-dashed animate-in fade-in duration-500">
            <div className="w-16 h-16 bg-slate-50 rounded-2xl flex items-center justify-center mb-4 text-slate-200">
                <FileCheck size={32} />
            </div>
            <p className="text-xs font-black text-slate-900 uppercase tracking-tight">Document Queue Empty</p>
            <p className="text-[10px] font-bold text-slate-400 mt-1 uppercase tracking-widest">Pending verifications will appear here</p>
        </div>
    );
