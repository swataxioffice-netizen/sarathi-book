    ...
    if (variant === 'compact') {
        return (
            <button
                ...
                className={`flex items-center gap-2 px-3 py-2 bg-[#F8FAFF] border border-blue-200 rounded-xl shadow-sm hover:shadow-md hover:border-blue-400 transition-all active:scale-95 group ${className}`}
            ...
            >
                ...
                <div className="flex flex-col items-start leading-none">
                    <span className="text-[10px] font-black text-blue-600 uppercase tracking-tight">Login</span>
